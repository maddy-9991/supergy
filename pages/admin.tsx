...
const CreateDeviceMutation = gql`
  mutation($title: String!, $url: String!, $imageUrl: String!, $category: String!, $description: String!) {
    createDevice(title: $title, url: $url, imageUrl: $imageUrl, category: $category, description: $description) {
      title
      url
      imageUrl
      category
...
const Admin = () => {
  ...
  const onSubmit = async data => {
    ...
    try {
      toast.promise(createDevice({ variables }), {
  ...
  return (
    <div className="container mx-auto max-w-md py-12">
      <Toaster />
      <h1 className="text-3xl font-medium my-5">Create a new Device</h1>
